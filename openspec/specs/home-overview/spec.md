...
Defines the home overview screen: the root dashboard destination showing background engine, greeting header, presence strip, active-device summary bar, scene quick-launch row, room grid, and now-playing media widget.
