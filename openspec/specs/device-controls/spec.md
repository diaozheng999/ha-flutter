...
Defines the reusable device control widgets used across room detail screens and the home overview: light toggle, brightness slider, colour temperature slider, fan speed dial, AC thermostat, media mini-player, and the glassmorphic card surface.
